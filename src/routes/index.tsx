        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="border-t border-white/20 pt-8">
            <div className="flex flex-col items-center justify-center text-sm text-white/80 space-y-4">
              ...
              <p className="font-semibold bg-clip-text text-transparent bg-gradient-to-r from-[#b8860b] via-[#daa520] to-[#b8860b] bg-[length:200%_auto] animate-[gold-shine_5s_linear_infinite]">✦ Feito com excelência ✦</p>
